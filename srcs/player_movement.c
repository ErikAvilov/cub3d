...
/*   Updated: 2022/12/15 13:59:49 by eavilov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_action(t_mlx_data *mlx_data)
{
	...
	if (is_pressed(mlx_data->moves.key, K_A) && !blocked(mlx_data, K_A))
		strafe_left(mlx_data, speed);
	if (is_pressed(mlx_data->moves.key, K_D) && !blocked(mlx_data, K_D))
